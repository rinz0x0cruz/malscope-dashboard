...
<template>
  <div class="space-y-5">
    <PageHeader eyebrow="malscope · correlate" title="Correlation graph"
      subtitle="How the corpus connects — shared C2 infrastructure, imphash code-similarity, and family. Hover a node to trace its links; click a report to open it." />
